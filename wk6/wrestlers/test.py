...
# params: wmap: a dictionary containing wrestler objects, referenced by wrestler name
#         rmap: a dictionary containing string arrays of rivals, referenced by wrestler name
...
# rivals in the wrester object map
